...
function HomePage(){
    return(
        <div className="homePage">
            ...
            <div className='homeDiv'>Love this website? Follow me <a className='link' rel="noopener noreferrer" target={"_blank"} href='https://www.instagram.com/w.liam.li/'>@jac.schedule</a> to support this project!</div>
            <div className='homeDiv'>To add a review, message <a className='link' rel="noopener noreferrer" target={"_blank"} href='https://www.instagram.com/w.liam.li/'>@jac.schedule</a> to give a review. Any review, good or bad is welcome!</div>
        </div>
    )
}
