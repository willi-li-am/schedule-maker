...
function HomePage(){
    return(
        <div className="homePage">
            <h1>JAC Mock Schedule Builder</h1>
            <div className = "homeDiv"><strong>Disclaimer:</strong> This website is only to <strong>prepare</strong> for course selection</div>
            <div className = "homeDiv"><strong>Official course selection</strong> can only be done on <strong>Omnivox</strong> at the scheduled date the college gives!</div>
        </div>
    )
}
